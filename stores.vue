                                    ...
                                    <div class="store_logo_container">
                                        <router-link :to="'/stores/'+ store.slug">
                                            <div v-if="!store.no_store_logo">
                                                <img class="transparent_logo" src="//codecloud.cdn.speedyrails.net/sites/5d6ffb506e6f641ac8200200/image/png/1536094188000/default_background.png">
                                                <img  class="store_img" :src="store.store_front_url_abs" alt="">
                                            </div>
                                            
                                            <div v-else class="no_logo_container">
                                                <img class="transparent_logo" src="//codecloud.cdn.speedyrails.net/sites/5d6ffb506e6f641ac8200200/image/png/1536094188000/default_background.png" alt="">
            ...
            created (){
                this.loadData().then(response => {
                    ...
                    if(temp_repo != null) {
                        ...
                        this.pageBanner = {
                            "image_url": "//codecloud.cdn.speedyrails.net/sites/5d6ffb506e6f641ac8200200/image/jpeg/1529532304000/insidebanner2.jpg"
                        }
                    }
