            ...
            watch: {
                ...
                currentStore: function () {
                    ...
                    if (_.includes(categories, delivery_category) && !_.isEmpty(subcategories)) {
                        ...
                        if (_.includes(subcategories, 8922)) {
                            this.hasUberEats = true;
                        }
                        if (_.includes(subcategories, 8919)) {
                            this.hasDoordash = true;
                        }
                        if (_.includes(subcategories, 8920)) {
                            this.hasGrubhub = true;
                        }
                        if (_.includes(subcategories, 8921)) {
                    ...
                    _.forEach(this.currentStore.promotions, function(value, key) {
                        ...
                        if (_.includes(current_promo.image_url, 'missing')) {
                            current_promo.image_url = "//codecloud.cdn.speedyrails.net/sites/5dded3ce6e6f6416ac040000/image/png/1529532181000/promoplaceholder2@2x.png";
                        }
                    ...
                    _.forEach(this.currentStore.events, function(value, key) {
                        ...
                        if (_.includes(current_event.image_url, 'missing')) {
                            current_event.image_url = "//codecloud.cdn.speedyrails.net/sites/5dded3ce6e6f6416ac040000/image/png/1529532187000/eventsplaceholder2@2x.png";
                        }
