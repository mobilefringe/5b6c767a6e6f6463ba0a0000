            ...
            <div v-if="dataLoaded" v-cloak>
                ...
                <div class="main_container">
                    <div class="location_map">
                        <iframe title="Google Map for Rancho San Diego" :src="propertyAddress()" width="100%" height="490" frameborder="0" style="border:0" allowfullscreen></iframe>
                    </div>
                </div>
                <div class="main_container">
                    <div class="row">
		...
		return Vue.component("location-component", {
            ...
            methods: {
                loadData: async function () {
                    ...
                    try {
                        let results = await Promise.all([this.$store.dispatch("getData", "repos"), this.$store.dispatch('LOAD_PAGE_DATA', {url: this.property.mm_host + "/pages/sandiego-location.json"})]);
                        return results;
                    } catch (e) {
