                    ...
                    _.forEach(events, function (value, key) {
                        ...
                        if (today >= showOnWebDate) {
                            ...
                            if (value.store != null && value.store != undefined && _.includes(value.store.image_url, 'missing')) {
                                value.store.image_url = "//codecloud.cdn.speedyrails.net/sites/5dded3ce6e6f6416ac040000/image/png/1537204516000/promoplaceholder2-2x.png";
                            }
                            
                            if (_.includes(value.image_url, 'missing')) {
                                value.image_url = "//codecloud.cdn.speedyrails.net/sites/5dded3ce6e6f6416ac040000/image/png/1537204598000/eventplaceholder2-2x.png";
                            }
