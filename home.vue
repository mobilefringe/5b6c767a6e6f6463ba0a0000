        ...
        <transition name="fade">
            <div v-if="dataLoaded" v-cloak>
                            ...
                            <div v-if="banner.name && banner.description" class="banner_height">
                                ...
                                <div class="banner_content_container">
                                    <div class="banner_content">
                                        ...
                                        <a :href="banner.url" :aria-label="'Go to details page regarding ' + banner.name ' banner.">
                ...
                <div class="main_container">
                    ...
                    <h2 class="home_title center" v-if="instaFeed">In Our Feed</h2>
                    ...
                    <div v-if="instaFeed" class="visible-xs margin_60 insta-feed-container">
                    ...
                    _.forEach(this.processedPromos, function(value, key) {
                        ...
                        if (today >= showOnWebDate) {
                            if (_.includes(value.image_url, 'missing')) {
                                value.image_url = "//codecloud.cdn.speedyrails.net/sites/5dded3ce6e6f6416ac040000/image/png/1537204516000/promoplaceholder2-2x.png";
                            }
            ...
            methods: {
                loadData: async function() {
                    try {
                        ...
                        // this.$store.dispatch('LOAD_PAGE_DATA', {url: " /social.json"})
                        return results;
                    } catch(e) {
